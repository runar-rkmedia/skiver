...
func (m *SnapshotMeta) validateCreatedAt(formats strfmt.Registry) error {
...
func (m *SnapshotMeta) validateDeleted(formats strfmt.Registry) error {
...
func (m *SnapshotMeta) validateID(formats strfmt.Registry) error {
...
func (m *SnapshotMeta) validateUpdatedAt(formats strfmt.Registry) error {
...
// ContextValidate validates this snapshot meta based on context it is used
func (m *SnapshotMeta) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
