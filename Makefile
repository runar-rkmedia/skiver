...
swagger-clean:
	...
	rg -tgo 'Code generated by go-swagger' models --files-with-matches
	rg -tgo 'Code generated by go-swagger' models --files-with-matches | xargs rm
swagger-watch:
	printf swagger.yml | entr -r go generate ./...
build-web:
	echo "frontend not created yet!"
